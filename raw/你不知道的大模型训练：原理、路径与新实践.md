...
tags:
  - "clippings"
---
<svg width="100%" height="200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" role="img" aria-label="你不知道的大模型训练：原理、路径与新实践"><path id="svg-title-path"></path><text font-size="36" font-weight="600" fill="#ffffff" x="50%" y="50%" text-anchor="middle" word-spacing="2.0" letter-spacing="1.2"><textPath xlink:href="#svg-title-path">你不知道的大模型训练：原理、路径与新实践</textPath></text></svg>
